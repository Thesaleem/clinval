const Footer = () => {
    return (
        <div className="hero text-off-white  pb-9 ">
            <div className="flex flex-col md:flex-row items-center justify-between w-[90%] pt-6 lg:pt-8 mt-10 mx-auto ">
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 text-3xl">
                    <a href="https://twitter.com/thesaleem_" target="_blank" rel="noreferrer" className="hover:scale-125"> 
                        <i className="fa-brands fa-twitter"></i> 
                    </a>
                    <a href="https://github.com/thesaleem" target="_blank" rel="noreferrer" className="hover:scale-125">
                        <i className="fa-brands fa-github"></i>
                    </a>                          
                    <a href="mailto:adekunleismail14@gmail.com" className='hover:scale-125' >
