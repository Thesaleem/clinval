...
const Form = () => {
    ...
    return (
      <div className="w-[90%] mt-10 mx-auto  pt-3 md:pt-5">
        <h1 className="text-3xl md:text-[40px] text-center">Contact us</h1>
        <p className="md:text-xl  md:pt-7 text-center leading-9 ">
          If you have any feedback or contribution to <br /> this tool, please
        ...
        >
            <div className="py-4 flex flex-col md:w-[50%] lg:w-[30%]">
                ...
                className={`${errors.name?.type === "required" ? 'border-[red]' : 'border-gray-300'} border mt-3 p-1 focus:outline-none w-full`}
                />
            ...
            <div className="pb-4 flex flex-col md:w-[50%] lg:w-[30%]">
                ...
                className={`${errors.email?.type === "required" || errors.email?.message ? 'border-[red]' : 'border-gray-300'} border mt-3 p-1 focus:outline-none w-full`}
                />
          ...
          {professionQues === 'Yes' && 
            ...
            <button className="mt-5 md:mt-0 w-full md:w-[50%] lg:w-[30%] bg-[#282525] text-white py-2 px-16 uppercase font-bold">
                Submit
            </button>
        </form>
      </div>
