...
const SmokingYears = () => {
    ...
    return (
        <Section>
            ...
            <SectionText>
                It is used to quantify smoking history. Smoking pack years can give your 
                doctor an idea of your risk level of developing lung cancer and other lung diseases.
            </SectionText>
